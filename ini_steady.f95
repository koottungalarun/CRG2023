subroutine ini_steady( co_dash,co_bar)
   use comvar
   implicit none
   ...
   do i=1,Nx
    ...
    co_dash(1, 1:Nx, 1:Ny, 1:Nz)   = 0.0 !Rho(:, :, :) - co_bar(1, 1:Nx, 1:Ny, 1:Nz)         
     

    write(*,*)'Set the initial condition'

end subroutine ini_steady
